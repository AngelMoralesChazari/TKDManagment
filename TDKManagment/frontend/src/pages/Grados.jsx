const gradosPlaceholder = [
  ...
  { orden: 2, nombre: 'Amarilla', color: 'bg-yellow-400', alumnos: 22 },
  { orden: 3, nombre: 'Verde', color: 'bg-green-500', alumnos: 18 },
  { orden: 4, nombre: 'Azul', color: 'bg-blue-600', alumnos: 14 },
  { orden: 5, nombre: 'Roja', color: 'bg-red-600', alumnos: 8 },
  { orden: 6, nombre: 'Negra', color: 'bg-slate-900', alumnos: 4 },
]
